...
<%
	//判断有没有栏目列表数据，如果没有跳转到columns.s?op=query
	if( request.getAttribute("columnsList") == null ){
		request.getRequestDispatcher("columns.s?op=query").forward(request, response);
	} 
%>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <!-- 增加栏目 -->
          <form action="columns.s" method="post" autocomplete="off">
            ...
            <div class="form-group">
              ...
              <select id="category-fname" class="form-control" name="parentId">
              	...
              	<!-- 为了得到value值，设置一个属性 -->
              	<% request.setAttribute("pId",${'#category-fname'}.val()); %> 
